...
const TargetCursor = ({
  targetSelector = 'a, button, .cursor-target, input, textarea, .project-card, [role="button"]',
  spinDuration = 2,
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      document.documentElement.style.cursor = 'none'; // Ensure html also has no cursor
    }
    ...
    const enterHandler = e => {
      ...
      // Also ignore if the target is just a plain div that happens to have the 'button' class, 
      // but assuming they wrote targetSelector carefully
      ...
      // Add a little padding to the target box 
      const padding = 4;
